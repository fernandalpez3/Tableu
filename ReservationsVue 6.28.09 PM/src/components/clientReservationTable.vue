<template>
        ...
        <div class='seat-stat-wrapper'>
          <button v-on:click="removeSeat">Remove seat</button>
          <button v-on:click="removeRow">Remove first row</button>
          <button v-on:click="removeSpace">Remove blank space</button>
...
export default {
  ...
  methods: {
    addTable: function() {
     ...
     removeSeat: function(){
        $('.seatCharts-seat:first').remove();
    },
    removeRow: function(){
       $('.seatCharts-row:first').remove(); 
    },
    addRow: function(){
      $('.seatCharts-row').remove();
			$('.seatCharts-legendItem').remove();
			...
			firstSeatLabel = 1;
			this.tablesMap.push('ee_ee');
			seatChartOpts.map = tablesMap;
			seatChartOpts.naming = {
				top: false,
				getLabel: function (character, row, column) {
					return firstSeatLabel++;
				},
